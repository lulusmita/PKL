    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        getStartedButton.addEventListener('click', function () {
            ...
            setTimeout(() => {
                ...
                loginFormContainer.style.display = 'flex'; // Pastikan untuk mengatur display ke flex
                loginFormContainer.style.animation = 'slideIn 0.1s forwards';  
            }, 500);
            // Auto scroll ke elemen dengan ID loginFormContainer
            setTimeout(() => {
                if (isMobile()) {
                    loginFormContainer.scrollIntoView({ behavior: 'smooth', block: 'center', inline: 'center' });
                }
