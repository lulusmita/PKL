        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <nav class="flex sm:hidden" aria-label="Breadcrumb">
                ...
                <li aria-current="page">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Rebalancing</span>
                    </div>
                </li>
                </ol>
            </nav>
            ...
            <div class="relative overflow-x-auto px-2">
                <div class="flex w-full items-center justify-between xl:flex-row flex-col space-y-4 xl:space-y-0 py-4 bg-white dark:bg-gray-900">
                    <div class="flex gap-2">
                        ...
                        <button onclick="window.location.href='exportExcelRebalancing'" type="file" class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                    ...
                    <div id="uploudExcel-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <form action="/importExcelRebalancing" method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="relative flex flex-col w-full xl:w-auto">
                        ...
                        <form action="/rebalancing" method="GET">
                            <input type="search" name="search" id="table-search-users" class="block pt-2 ps-10 text-sm h-9 text-gray-900 border border-gray-300 rounded-lg w-full xl:w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for Site ID">
                        </form>
                    </div>
                </div>
                @include('fulfillment.components.rebalancingTable', ['hideSiteName' => true])
                @include('fulfillment.components.modalRebalancing')

                <!-- Modal toggle -->

            </div>
            {{ $dataRebalancing->appends(Request::except('page'))->render() }}
        </div>
