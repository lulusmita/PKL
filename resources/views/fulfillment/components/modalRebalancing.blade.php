        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Kamu yakin untuk menghapus rebalancing dengan ID Tiara <span class="text-merah">{{$row->newLinkFulfillment->ID_Tiara_Enom}}</span>?</h3>
