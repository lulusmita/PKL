...
<body>
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <nav class="flex sm:hidden" aria-label="Breadcrumb">
                ...
                <li>
                    ...
                    <a href="/fulfillment" class="ms-1 text-sm font-medium text-gray-700 hover:text-merah md:ms-2 dark:text-gray-400 dark:hover:text-white">Fulfilment</a>
                    </div>
                </li>
                <li aria-current="page">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">New Link</span>
                    </div>
                </li>
                </ol>
            </nav>
            ...
            <div class="relative overflow-x-auto px-2">
                <div class="flex w-full items-center justify-between xl:flex-row flex-col space-y-4 xl:space-y-0 py-4 bg-white dark:bg-gray-900">
                    <div class="flex gap-2">
                        <button data-modal-show="tambahNewLinkModal" data-modal-target="tambahNewLinkModal" type="button" class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                            <span class="sr-only">Add New Link</span>
                            Add New Link
                            <svg class="w-5 h-5 ms-2.5 hidden lg:block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
                        ...
                        <button data-modal-target="uploudExcel-modal" data-modal-toggle="uploudExcel-modal" id="file_input" type="file" class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                            ...
                            Import Excel
                            <svg class="w-5 h-5 ms-2.5 hidden lg:block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <button onclick="window.location.href='exportExcelNewlink'" type="file" class="inline-flex items-center text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                    ...
                    <div id="uploudExcel-modal" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative p-4 w-full max-w-md max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <form action="/importExcelNewlink" method="POST" enctype="multipart/form-data">
                                    @csrf
                    ...
                    <div class="relative flex flex-col w-full xl:w-auto">
                        ...
                        <form action="/newLink" method="GET">
                ...
                @include('fulfillment.components.newLinkTable', ['hideSiteName' => true])
